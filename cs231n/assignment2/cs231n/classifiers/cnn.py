...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        ############################################################################
        self.params['W1'] = np.random.normal(0, weight_scale, num_filters*input_dim[0]*filter_size*filter_size).reshape(num_filters, input_dim[0],filter_size,filter_size)
        self.params['b1'] = np.zeros(num_filters)
        temp = int(num_filters*input_dim[1]*input_dim[2]/4)
        self.params['W2'] = np.random.normal(0, weight_scale, temp*hidden_dim).reshape(temp, hidden_dim)
